...
return [
    'configs' => [
        [
            ...
            /*
             * The class name of the model that is related to the webhook call.
             *
             * This should be set to a class that extends \TimoCuijpers\WebhookClient\Models\WebhookCall.
             */
            'webhook_related_model' => '',
        ],
    ],
